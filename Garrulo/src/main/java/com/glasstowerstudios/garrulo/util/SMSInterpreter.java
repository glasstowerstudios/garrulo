 ...
 */
public class SMSInterpreter implements Interpreter {
  ...
  public String[] interpretMessage(GarruloMessage aMessage) {
    ...
    String phoneNumber = aMessage.getSender();
    String contactName = getContactNameOrNumber(phoneNumber);
    String messageFrom = "New message from " + contactName;
    CharSequence messageBody = aMessage.getTextContent();
    Log.d(LOGTAG, "messages[0]: " + messageFrom);
    messages[0] = messageFrom;
    Log.d(LOGTAG, "messages[1]: " + messageBody);
    StringBuilder bldr = new StringBuilder();
    bldr.append(messageBody);
    messages[1] = bldr.toString();
